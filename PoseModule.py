...
#Creates poseDetector Class
class poseDetector():

    def __init__(self, mode=False, complexity=1, smooth=True,
                 segmentation=False, smooth_seg=True, detectioncon=0.5, trackingcon=0.5):
        self.mode = mode
        ...
        self.pose = self.mpPose.Pose(self.mode, self.complexity, self.smooth, self.segmentation,
                                     self.smooth_seg, self.detectioncon, self.trackingcon)
...
#Method for finding pose
    def findPose(self, img, draw=True):
        ...
        return img
#Method for finding the positions of each landmark
    def findPosition(self, img, draw=True):
        ...
        return self.lmList
#Finds the angles given 3 landmarks
